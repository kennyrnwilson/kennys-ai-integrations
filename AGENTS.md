...
The one agent guide for this repo, read by Claude Code and Codex alike.
`CLAUDE.md` is a pointer to this file. System-wide context (devices, runners,
MCP, backups) lives in the personal-portal system docs — link, don't duplicate.
